...
public class AxiomTypesTable extends Table{
	 ...
	 public static final Collection<AxiomType<? extends OWLAxiom>> CLASS_AXIOM_TYPES = new ArrayList<>(
			 Arrays.asList(SUBCLASS_OF, EQUIVALENT_CLASSES, DISJOINT_CLASSES
						   //DISJOINT_UNION, HAS_KEY
			 ));
	 @SuppressWarnings("unchecked")
	 public static final Collection<AxiomType<? extends OWLAxiom>> OBJECT_PROPERTY_AXIOM_TYPES = new ArrayList<>(
			 Arrays.asList(
	 ...
	 @SuppressWarnings("unchecked")
	 public static final Collection<AxiomType<? extends OWLAxiom>> DATA_PROPERTY_AXIOM_TYPES = new ArrayList<>(
			 Lists.newArrayList(
	...
	private Set<AxiomType<OWLAxiom>> selectedAxiomsTypes = new HashSet<>();
...
//		setHeightUndefined();
		...
		container = new BeanItemContainer<>(AxiomType.class);
...
//		container.sort(new String[]{"name"}, new boolean[]{true});
	...
	private static AxiomType allAxioms(){
		try {
			Constructor<AxiomType> constructor = AxiomType.class.getDeclaredConstructor(Class.class, int.class, String.class, boolean.class, boolean.class, boolean.class);
			constructor.setAccessible(true);
			AxiomType all = constructor.newInstance(OWLSubClassOfAxiom.class, 50, "All", false , false, false);
			return all;
