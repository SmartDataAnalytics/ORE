...
public class StructuralTopTester implements OWLClassExpressionVisitorEx<Boolean> {

	public StructuralTopTester() {
		bottomChecker = new StructuralBottomTester();
	}
	...
	private StructuralBottomTester bottomChecker;
}
